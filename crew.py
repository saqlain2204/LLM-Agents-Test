...
# Create Tasks
content_plan_task = tasks.contentPlan(agent=content_planner_agent, topic=topic, llm=llm)
content_write_task = tasks.contentWrite(agent=content_writer_agent, topic=topic, llm=llm)
